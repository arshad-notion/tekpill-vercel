...
export const getCountryName = (timezoneCity: string) => {
  const cityArr = timezoneCity.split("/");
  const city = cityArr[cityArr.length - 1];
  return getCountryListPerCity()[city];
};

const getCountryListPerCity = (): IObjectKeys => {
  return {
    Andorra: "Andorra",
